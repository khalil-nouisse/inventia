...
export function LandingPage(){return <main className="landing"><section className="landing__content"><div className="landing__copy"><span className="eyebrow">InventIA competition workspace</span><h1>Build, submit, judge, and celebrate hackathon projects.</h1><p>Run ENSAM AI competitions with one polished workspace for teams, submissions, scoring, analytics, and exports.</p><div className="landing__actions"><Link className="primary" to="/hackathons"><Rocket size={18}/>View hackathons</Link><Link className="secondary-link" to="/register">Create account</Link></div></div><div className="landing__poster" aria-hidden="true"><span>AI Sprint</span><strong>InventIA Challenge</strong><div><b>Teams</b><b>Submissions</b><b>Leaderboard</b></div></div></section></main>}
