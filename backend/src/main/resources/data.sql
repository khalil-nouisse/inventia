...
(1, 'admin', 'admin@inventia.local', '$2a$10$Jov4M9AEr1H77cXKIy0k8ug.6C/OXRMvNRc039uye.tVdF3sluPNq', 'Admin', 'InventIA', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'manager', 'manager@inventia.local', '$2a$10$Jov4M9AEr1H77cXKIy0k8ug.6C/OXRMvNRc039uye.tVdF3sluPNq', 'Manager', 'InventIA', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'user', 'user@inventia.local', '$2a$10$Jov4M9AEr1H77cXKIy0k8ug.6C/OXRMvNRc039uye.tVdF3sluPNq', 'User', 'InventIA', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
