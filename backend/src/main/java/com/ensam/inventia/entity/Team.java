...
public class Team {
 ...
 @Column(unique=true, nullable=false) private String joinCode;
 ...
 @PrePersist void prePersist(){createdAt=LocalDateTime.now(); updatedAt=createdAt; if(joinCode==null) joinCode=UUID.randomUUID().toString();} @PreUpdate void preUpdate(){updatedAt=LocalDateTime.now();}
}
