...
import com.ensam.inventia.dto.response.ApiResponse; import org.springframework.http.*; import org.springframework.web.bind.MethodArgumentNotValidException; import org.springframework.web.bind.annotation.*; import org.springframework.web.multipart.MaxUploadSizeExceededException;
...
public class GlobalExceptionHandler {
 ...
 @ExceptionHandler(MaxUploadSizeExceededException.class) @ResponseStatus(HttpStatus.PAYLOAD_TOO_LARGE) ApiResponse<Void> uploadTooLarge(MaxUploadSizeExceededException e){return ApiResponse.fail("ZIP file is too large. Maximum upload size is 200MB.",413);}
}
